    ...
    public function ticket()//Dashboard
     ...
     $comentarios=DB::table('hd_comentarios')->
      ...
      $hd_reg_tickets =DB::table('hd_reg_tickets')->
          ...
          select('hd_reg_tickets.id','hd_reg_tickets.cTitulo','hd_categorias.cCategorias','hd_sistemas.cSistema','hd_prioridad.cNPrioridad','hd_users.cNombre','hd_users.cApellidos','hd_reg_tickets.created_at','hd_estado.ccEstado','hd_reg_tickets.nAtendio','hd_reg_tickets.nFolio_Users')
          ->where('hd_reg_tickets.nAtendio',Auth()->user()->id)->orWhere('hd_reg_tickets.nFolio_users',Auth()->user()->id)->get();
     ...
     public function buscarEntre(Request $request)//Dashboard
     {
      ...
      select('hd_users.cNombre','hd_comentarios.cComentarios','hd_comentarios.nFolio_ticket','hd_comentarios.created_at','hd_users.badmin','hd_reg_tickets.nFolio_Users','hd_reg_tickets.nAtendio')->where('nAtendio',auth()->user()->id)->where('badmin',0)->get();
       ...
       $hd_reg_tickets =DB::table('hd_reg_tickets')->
          ...
          leftjoin('hd_sistemas','hd_sistemas.id','=','hd_reg_tickets.cSistema')->
          leftjoin('hd_prioridad','hd_prioridad.id','=','hd_reg_tickets.cPrioridad')->
          select('hd_reg_tickets.id','hd_reg_tickets.cTitulo','hd_categorias.cCategorias','hd_sistemas.cSistema','hd_prioridad.cNPrioridad','hd_users.cNombre','hd_users.cApellidos','hd_reg_tickets.created_at','hd_estado.ccEstado','hd_reg_tickets.nAtendio')
          ->whereBetween('hd_reg_tickets.created_at',[$desde,$hasta])->
          where('hd_reg_tickets.nAtendio',Auth()->user()->id)->get();
