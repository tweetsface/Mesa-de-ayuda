...
class notificaciones extends Mailable
{
    ...
    public function build()
    {
         ...
         return $this->from($address='helpdesk@aparedes.com.mx', $name = 'Agricola Paredes')->subject('Ticket generado con exito')->view('notificaciones')->with('hd_reg_tickets',$hd_reg_tickets);
    }
}
