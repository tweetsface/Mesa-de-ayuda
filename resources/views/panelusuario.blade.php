...
<div class="form-group">
    <label for="cSistema" class='etiquetas'><b>Sistema:</b></label>
     <select  class="form-control" name="cSistema" id="cSistema" name="cSistema" placeholder="Sistema">
    <option>1</option>
    <option>2</option>
    <option>3</option>
    <option>4</option>
...
<div class="form-group">
    <label for="Prioridad" class='etiquetas'><b>Prioridad:</b></label>
     <select  class="form-control" name="cPrioridad" id="cPrioridad" placeholder="Prioridad"  >
    <option>1</option>
    <option>2</option>
    <option>3</option>
    <option>4</option>
